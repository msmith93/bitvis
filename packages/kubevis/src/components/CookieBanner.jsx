    ...
    >
      ...
      <div style={{ display: 'flex', gap: '10px', flexShrink: 0 }}>
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.backgroundColor = '#22345c'
            e.currentTarget.style.borderColor = '#3a568c'
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor = '#1a2a4d'
            e.currentTarget.style.borderColor = '#29406e'
          }}
        >
          Decline
        </button>
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.backgroundColor = '#5285ea'
            e.currentTarget.style.transform = 'scale(1.05)'
            /* hover brightens the Kubernetes blue */
          }}
          onMouseLeave={(e) => {
