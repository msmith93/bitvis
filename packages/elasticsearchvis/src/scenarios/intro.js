...
const STEPS = [
  ...
  },
  {
    ...
    body: 'The rest of the lessons live behind this button: leading wildcards, fuzzy matching, routing keys, why the same query ranks differently, and the on-disk term dictionary. Click it for a look — you do not have to start one.',
